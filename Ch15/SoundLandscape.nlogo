...
to setup
  ...
  crt 1 [
    ...
    set shape "circle" ]
  ask patches
  [ set pcolor random 200
    set slength (50 + random 200) / 1000]
  repeat 15 [diffuse pcolor .5]
end
...
to play-note
  set clock 0
  sound:play-note-later clock (item Instrument sound:instruments) pcolor 64 slength
  set clock clock + slength
end
@#$#@#$#@
GRAPHICS-WINDOW
60
